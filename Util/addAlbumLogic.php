...
if (isset($_POST)) {
    ...
    if ($verified_description && $verified_title && $verified_service && $verified_label && $verified_img && $images_add) {
        ...
        $user_id=$_SESSION["ln_userId"];
        $sql = "INSERT INTO album(user_id,album_title,album_description,album_label,album_isActive,typeId) VALUES( $user_id,'$title','$description','$label','$active','$type')";
