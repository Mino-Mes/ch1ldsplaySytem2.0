            ...
            <div id="Photographs" class="tabcontent">
                <form method="POST" id="PhotoForm">
                    <div class="row gtr-uniform" style="text-align: center">
                        ...
                        <div class="col-6">
                            <input type="radio" name="photoSearch" id="pSearch1" value="byCreator" onclick="orderByPhoto(1)">
                            <label for="pSearch1">Creator Username</label>
                            <input type="radio" name="photoSearch" id="pSearch2" value="albumTitle" onclick="orderByPhoto(2)">
                            <label for="pSearch2">Album Title</label>
                            <input type="radio" name="photoSearch" id="pSearch3" value="all" onclick="orderByPhoto(0)" checked>
                            <label for="pSearch3">All Photographs</label>
                            <div id="photoSearchBoxContainer">
                        ...
                        <div class="col-4">
                            <input type="checkbox" name="photoImages" id="photoImages">
                            <label for="photoImages">Show Images</label>
                        </div>
                        <div class="col-4">
                        ...
                        <div class="col-4">
                            <input type="radio" name="photoOrder" id="photoCreator" value="creator">
                            <label for="photoCreator">Creator username</label>
                            <input type="radio" name="photoOrder" id="photoAlbum" value="album" checked>
                            <label for="photoAlbum">Album Title</label>
                        </div>
                        <div class="col-4">
...
<script>
    $("form#PhotoForm").submit(function (e) {
        e.preventDefault();
        var formData = new FormData(this);

        $.ajax({
            url: "../Util/report2Logic.php",
            type: "POST",
            data: formData,
            success: function (data) {
                document.getElementById("photoReportContainer").innerHTML = data;
            },
            cache: false,
            contentType: false,
            processData: false
    ...
    function showAdvancedSettings() {
        ...
        xhttp.open("POST", "../Util/report2Logic.php", true);
        xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    ...
    function orderByPhoto(isActive)
    {
        if(isActive ==1)
        {
            document.getElementById("photoSearchBoxContainer").innerHTML = "<label>Input Creator Username</label><input type='text' name='creatorSearch' id='creatorSearch' placeholder='creator username'>";
        }else if(isActive ==2)
        {
            document.getElementById("photoSearchBoxContainer").innerHTML = "<label>Input Album Title</label><input type='text' name='albumSearch' id='albumSearch' placeholder='Album Title'>";
        }else if(isActive ==0)
        {
            document.getElementById("photoSearchBoxContainer").innerHTML ="";
        }
    }
